...
"MSWin32-x86-multi-thread-10.0.19042.508" or
	die "Errno architecture (MSWin32-x86-multi-thread-10.0.19042.508) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAENAMETOOLONG WSAEAFNOSUPPORT WSAEINPROGRESS WSAEALREADY
	WSAEPROTOTYPE WSAEREFUSED WSAETIMEDOUT WSAENOTCONN WSAECONNRESET
	WSAEHOSTUNREACH WSAEADDRNOTAVAIL WSAENOTEMPTY WSAEMSGSIZE WSAEINVAL
	WSAEDESTADDRREQ WSAEWOULDBLOCK WSAEPFNOSUPPORT WSAEACCES WSAEDISCON
	WSAEPROCLIM WSAEFAULT WSAENOPROTOOPT WSAEREMOTE WSAENOMORE
	WSAENETRESET WSAECONNABORTED WSAESTALE WSAEHOSTDOWN WSAECONNREFUSED
	WSAECANCELLED WSAENETDOWN WSAEBADF WSAEINVALIDPROCTABLE WSAENETUNREACH
	WSAESOCKTNOSUPPORT WSAEPROVIDERFAILEDINIT WSAEMFILE WSAESHUTDOWN
	WSAEPROTONOSUPPORT WSAEADDRINUSE WSAENOTSOCK WSAEDQUOT WSAEINTR
	WSAENOBUFS WSAETOOMANYREFS WSAEOPNOTSUPP WSAELOOP WSAEISCONN WSAEUSERS
	WSAEINVALIDPROVIDER
    )],
);
